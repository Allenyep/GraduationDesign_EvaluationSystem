...
(function (b) {
    ...
    a.prototype = {
        constructor: a, init: function () {
            ...
            var d = this.initItems("M"), e, f, h = this.options.template.indexOf("MMMM") !== -1,
            ...
            var e = this.initItems("h"), f, h, k = this.options.template.indexOf("h") !== -1,
...
(function (g) {
    ...
    h.prototype = {
        constructor: h, _process_options: function (n) {
            ...
            var o = [], r = this.viewDate.getUTCFullYear(), s = this.viewDate.getUTCMonth(), n = this.date.valueOf(),
                p = new Date();
            ...
            var F = new Date(this.viewDate), w = F.getUTCFullYear(), G = F.getUTCMonth(),
                ...
                u = this.date && this.date.valueOf(), q;
    ...
    m.prototype = {
        updateDates: function () {
            ...
            var r = g(q.target).data("datepicker"), p = r.getUTCDate(), o = g.inArray(q.target, this.inputs),
    ...
    function f(q, t) {
        var s = g(q).data(), n = {}, r, p = new RegExp("^" + t.toLowerCase() + "([A-Z])"),
    ...
    var i = {
        ...
        parseDate: function (q, A, u) {
            ...
            var t = q && q.match(this.nonpunctuation) || [], q = new Date(), y = {},
                z = ["yyyy", "yy", "M", "MM", "m", "mm", "d", "dd"], B = {
                    yyyy: function (E, s) {
