...
<div class="am-g tpl-g">
    ...
    <div class="left-sidebar">
        ...
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-nav-link">
                <a href="${basePath}loading/tprofile.do?idT=1" class="active" target="index">
    ...
    <div class="tpl-content-wrapper">
        <iframe name="index" src="${basePath}loading/tprofile.do?idT=1" height="100%" width="100%"></iframe>
    </div>
