                    ...
                    <div class="widget-head am-cf">
                        <h1>
                            ...
                            <small>
                                ...
                                <a href="javascript:window.history.go(-2)">得分表</a>
                                <small>
                                    <i class="icon-double-angle-right"></i>
                                    <a href="javascript:window.history.go(-1)">能力点得分详情</a>
                                    <small>
                                        <i class="icon-double-angle-right"></i>
                                        查看试题
                                    </small>
                    ...
                    <div class="widget-body am-fr">
                        <form class="am-form tpl-form-border-form tpl-form-border-br">
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <input type="text" class="tpl-form-input" disabled value="${mhtps.get(0).answerHtp}">
                                </div>
                                ...
                                <div class="am-u-sm-9">
                                    <input type="text" class="tpl-form-input" disabled value="${mhtps.get(0).timeconsumingHtp}">
                                </div>
                            </div>
