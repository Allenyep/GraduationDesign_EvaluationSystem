                ...
                <div>
                    <div id="user-profile-1" class="user-profile row">
                        <div class="col-xs-12 col-sm-3 center">
                            ...
                            <div class="clearfix">
                                <div class="grid2">
                                    <span class="bigger-175 blue">${evaluatetimes.size()}</span>
                                ...
                                <div class="grid2">
                                    <span class="bigger-175 blue">${practisetimes.size()}</span>
                            ...
                            <div class="profile-user-info profile-user-info-striped">
                                <div class="profile-info-row">
                                    ...
                                    <div class="profile-info-value">
                                        <span class="editable">${student.major.nameM}</span>
                                    </div>
                                </div>
                                ...
                                <div class="profile-info-row">
                                    ...
                                    <div class="profile-info-value">
                                        <span class="editable">${student.idS}</span>
                                    </div>
                                </div>
                                ...
                                <div class="profile-info-row">
                                    ...
                                    <div class="profile-info-value">
                                        <span class="editable">${student.nameS}</span>
                                    </div>
                                </div>
                                ...
                                <div class="profile-info-row">
                                    ...
                                    <div class="profile-info-value">
                                        <span class="editable">${student.dateS}</span>
                                    </div>
                                </div>
                                ...
                                <div class="widget-body">
                                    <div class="widget-main padding-8">
                                        <div id="profile-feed-1" class="profile-feed">
                                            <c:forEach items="${evaluatetimes}" var="e">
